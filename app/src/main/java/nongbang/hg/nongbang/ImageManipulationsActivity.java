...
public class ImageManipulationsActivity extends Activity implements CvCameraViewListener2 {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        outlineimageview=(ImageView)findViewById(R.id.scan_outline);
        outlineimageview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (viewMode==VIEW_MODE_RGBA) {
                    viewMode = VIEW_MODE_CANNY;
                    outlineimageview.setImageResource(R.drawable.scaleaf1);
                }else {
                    viewMode=VIEW_MODE_RGBA;
                    outlineimageview.setImageResource(R.drawable.scaleaf);
                }
            }
        });
